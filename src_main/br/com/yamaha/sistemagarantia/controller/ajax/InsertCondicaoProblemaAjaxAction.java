 ...
 *   .: Criação.....01 de Outubro, 12:28
 *   .: Autor.......Edson Luiz Sumensari
 *   .: Descrição...Action de serviço para inserir um item de Condição de problema para uma Inofrmações de Mercado.
 */
...
/** Action de serviço para inserir um item de Condição de problema para uma Inofrmações de Mercado.
 * 
...
public class InsertCondicaoProblemaAjaxAction extends InfraAjaxDefaultAction {
    ...
    public String getXmlContent( ActionMapping mapping
    	...
    	try {
    		...
    		//System.out.println("Condição : " + request.getParameter("condicaoTxt") );
    		...
    		if ( request.getParameter("entityId") != null ) {
	    		...
	    		//System.out.println("Condição enviada:" + condicaoTxt);
