 ...
 *   .: Criação.....28 de agosto de 2007, 08:52
 *   .: Autor.......Gisele Panosso
 *   .: Descrição...Entidade "RelatorioGarantiaPecasVO".
 */
...
public class RelatorioGarantiaPecasVO extends EntityObject {
    ...
    /** Armazena o campo listVlAcmMobra (lista de valor acumulado de mão de obra) do relatório Garantia e Peças.*/
    private List listVlAcmMobra;
    
    /** Armazena o campo listSubtotal (lista de valor do subtotal) do relatório Garantia e Peças.*/
    private List listSubtotal;   
    
    /** Armazena o campo listOrcPcsMobra (lista de Orcamento de Peças + Mobra) do relatório Garantia e Peças.*/
    private List listOrcPcsMobra;   
    
    /** Armazena o campo listRevisoes (lista de Detalhes da Revisão) do relatório Garantia e Peças.*/
    private List listRevisoes; 
    
    /** Armazena o campo listOrcRevisao (lista de Orçamento da Revisão) do relatório Garantia e Peças.*/
    private List listOrcRevisao;
    
    /** Armazena o campo listOrcTotal (lista de Orçamento Total da Revisão) do relatório Garantia e Peças.*/
    private List listOrcTotal;
    
    /** Armazena o campo listTotal (lista de valor Total = Subtotal + Tot Revisões) do relatório Garantia e Peças.*/
    private List listTotal;  
    
    /** Armazena o campo listVlFatur (lista de valor do Faturamento) do relatório Garantia e Peças.*/
    private List listVlFatur;    
    
    /** Armazena o campo listQtdes (lista de qtde de moto, sg's e faturada) do relatório Garantia e Peças.*/
    private List listQtdes;       
    
    /** Armazena o campo listGarVlFatur (lista de valor Garantia/Vl Faturado) do relatório Garantia e Peças.*/
    private List listGarVlFatur;    
    
    /** Armazena o campo listRevVlFatur (lista de valor Total Revisões/Vl Faturado) do relatório Garantia e Peças.*/
    private List listRevVlFatur;  
    
    /** Armazena o campo listTotVlFatur (lista de valor Total/Vl Faturado) do relatório Garantia e Peças.*/
	...
	/** Adiciona uma lista de valores acumulados da mão de obra no relatório Garantia e Peças.
     * 
     *  @param listRevisoes
	...
	/** Adiciona uma lista de valores do Subtotal no relatório Garantia e Peças.
     * 
     *  @param listSubtotal
	...
	/** Adiciona uma lista de valores do Orçamento e Peças + Mobra no relatório Garantia e Peças.
     * 
	...
	/** Adiciona uma lista de valores das Revisões no relatório Garantia e Peças.
     * 
     *  @param listRevisoes
     *      listRevisoes a ser adicionado.
     *  
	...
	/** Adiciona uma lista de valores do Orçamento das Revisões no relatório Garantia e Peças.
     * 
	...
	/** Adiciona uma lista de valores do Total no relatório Garantia e Peças.
     * 
     *  @param listTotal
	...
	/** Adiciona uma lista de valores do faturamento no relatório Garantia e Peças.
     * 
     *  @param listVlFatur
	...
	/** Adiciona uma lista de valores da qtde de moto, sg's e faturada no relatório Garantia e Peças.
     * 
     *  @param listQtdes
	...
	/** Adiciona uma lista de valor Garantia/Vl Faturado no relatório Garantia e Peças.
     * 
     *  @param listRevisoes
     *      listRevisoes a ser adicionado.
     *  
	...
	/** Adiciona uma lista de valor Total Revisões/Vl Faturado no relatório Garantia e Peças.
     * 
     *  @param listRevisoes
     *      listRevisoes a ser adicionado.
     *  
	...
	/** Adiciona uma lista de valor Total/Vl Faturado no relatório Garantia e Peças.
     * 
	...
	/** Método getter para a propriedade listOrcPcsMobra.
	 *
	...
	/** Método getter para a propriedade listOrcRevisao.
	 *
	...
	/** Método getter para a propriedade listOrcTotal.
	 *
	...
	/** Obtém o valor atual de listOrcPcsMobra.
	 * 
	 *  @param listOrcPcsMobra 
	...
	/** Obtém o valor atual de listOrcRevisao.
	 * 
	 *  @param listOrcRevisao 
	...
	/** Obtém o valor atual de listOrcTotal.
	 * 
	 *  @param listOrcTotal 
