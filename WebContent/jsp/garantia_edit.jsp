...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			var alterState = "<bean:write name='garantiaForm' property='alterState'/>";
			...
			function removeService(servicoCode) {
				...
				if ( window.confirm( "Confirma a remoção do serviço nº " + servicoCode  + "?" ) ) {
					...
					var garantiaId = window.document.garantiaForm.entityId.value;
				
					window.location.href = "Garantia.do?task=removeService&garantiaId=" + garantiaId + "&servicoCode=" + servicoCode;
			...
			function gravarForm(form) {
	    		...
	    		for (i=0;i<window.document.garantiaForm.recall.length;i++){ 
    			
       				if (window.document.garantiaForm.recall[i].checked) {
       				
          				value = window.document.garantiaForm.recall[i].value; 
	...
	<body leftmargin="0" topmargin="3">	
		...
		<html:form action="/Garantia" method="post">			
			...
			<tr height="25"> 
				...
				<td width="75%" class="text">				
					<bean:write name="garantiaForm" property="chassi"/>
				</td>
			</tr>
			<tr height="25"> 
				<td width="25%" class="td_dark">	
				...
				<td width="75%" class="text">													
					<html:radio property="recall" value="S" disabled="true"/>&nbsp; 
					<bean:message key="form.msg.yes"/>	&nbsp;&nbsp;	
					<html:radio property="recall" value="N" disabled="true"/>&nbsp; 
					<bean:message key="form.msg.no"/>  &nbsp;&nbsp; 
				</td>
			</tr>
			<logic:equal name="garantiaForm" property="recall" value="S">
			...
			<logic:equal name="garantiaForm" property="idTipo" value="1">
				<tr height="25"> 
					<td width="25%" class="td_dark">	
					...
					<td width="75%" class="text">
						<logic:equal name="garantiaForm" property="alterState" value="true">
							<html:text property="km" styleClass="text_field_menor" disabled="true"/>
						</logic:equal>
						<logic:equal name="garantiaForm" property="alterState" value="false">
							<html:text property="km" styleClass="text_field_menor"/>
			...
			<logic:equal name="garantiaForm" property="idTipo" value="2">
				<tr height="25"> 
					<td width="25%" class="td_dark">	
					...
					<td width="75%" class="text">
						<logic:equal name="garantiaForm" property="alterState" value="true">
							<html:text property="diasUso" styleClass="text_field_menor" maxlength="10" disabled="true"/>
				...
				<tr height="25"> 
					...
					<td width="75%" class="text">
						<logic:equal name="garantiaForm" property="alterState" value="true">
							<html:text property="horasUso" styleClass="text_field_menor" maxlength="10" disabled="true"/>
						</logic:equal>
						<logic:equal name="garantiaForm" property="alterState" value="false">
			...
			<div id="isRecall_1">	
				...
				<tr height="25"> 
					...
					<td width="75%" class="text">	
						<logic:equal name="garantiaForm" property="alterState" value="true">
							<html:select property="sintoma" styleClass="listSelect" disabled="true">
								<html:optionsCollection property="listSintomas" value="entityId" label="descricaoCode" />
							</html:select>
						</logic:equal>
						<logic:equal name="garantiaForm" property="alterState" value="false">
							<html:select property="sintoma" styleClass="listSelect" >
				...
				<tr height="25"> 
					...
					<td width="75%" class="text">
						<logic:equal name="garantiaForm" property="alterState" value="true">
							<html:select property="condicao" styleClass="listSelect" disabled="true">
								<html:optionsCollection property="listCondicoes" value="entityId" label="descricaoCode" />
							</html:select>
						</logic:equal>
						<logic:equal name="garantiaForm" property="alterState" value="false">
							<html:select property="condicao" styleClass="listSelect" >
								<html:option value=""></html:option>
								<html:optionsCollection property="listCondicoes" value="entityId" label="descricaoCode" />
							</html:select>
							<img src="../images/icon_required.gif" alt="form.msg.required"/>  
				...
				<tr height="25"> 
					<td width="25%" class="td_dark">	
						<bean:message key="garantia.form.sg.defeito"/>:
					</td>
					<td width="75%" class="text">	
						<logic:equal name="garantiaForm" property="alterState" value="true">
							<html:select property="defeito" styleClass="listSelect" disabled="true">
								<html:option value=""></html:option>
								<html:optionsCollection property="listDefeitos" value="entityId" label="descricaoCode" />
							</html:select>
						</logic:equal>
						<logic:equal name="garantiaForm" property="alterState" value="false">
							<html:select property="defeito" styleClass="listSelect">
								<html:option value=""></html:option>
								<html:optionsCollection property="listDefeitos" value="entityId" label="descricaoCode" />
							</html:select>
						</logic:equal>
			...
			<tr height="25"> 
				...
				<td width="75%" class="text">	
					<logic:equal name="garantiaForm" property="alterState" value="true">
						<html-el:select property="autEsp" styleClass="listSelect" disabled="true">
					...
					<logic:equal name="garantiaForm" property="alterState" value="false">
						...
						<html-el:select property="autEsp" styleClass="listSelect">
			...
			<div id="isRecall_2">	
				...
				<tr height="25"> 
					...
					<td width="75%" class="text">
						<logic:equal name="garantiaForm" property="alterState" value="true">
							<html-el:text property="servTer" styleClass="text_field_menor" disabled = "true"/>
						</logic:equal>	
						<logic:equal name="garantiaForm" property="alterState" value="false">
				...
				<tr height="50"> 
					...
					<td width="75%" class="text">
						<logic:equal name="garantiaForm" property="alterState" value="true">	
							<html-el:textarea property="justif" styleClass="text_field_menor" rows="5" disabled = "true"/>
						</logic:equal>
						<logic:equal name="garantiaForm" property="alterState" value="false">
							<html-el:textarea property="justif" styleClass="text_field_menor" rows="5"/>
						</logic:equal>
					</td>
				</tr>	
				<tr> 
				...
				<core:if test="${qtdeServicos > 0}">
					<core:forEach var="i" begin="1" end="${qtdeServicos}">
						<tr> 
							...
							<td width="75%" class="text">
								<logic:equal name="garantiaForm" property="alterState" value="true">							
									<input type="text" name="servico_<core:out value='${i}'/>" size="5" maxlength="5" disabled="disabled" >							
								</logic:equal>
								<logic:equal name="garantiaForm" property="alterState" value="false">
									<input type="text" name="servico_<core:out value='${i}'/>" size="5" maxlength="5">&nbsp; 
			...
			<tr height="25">
				<td colspan="2" align="center">
					<logic:equal name="garantiaForm" property="alterState" value="true">
						<html:button property="gravar" styleClass="button_medium"  onclick="javascript:return gravarForm(garantiaForm)" disabled="true"><bean:message key="form.btn.save"/></html:button>	
						&nbsp;
