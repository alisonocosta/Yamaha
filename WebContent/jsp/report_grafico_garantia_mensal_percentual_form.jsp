 ...
 *   .: Objeto......report_grafico_garantia_mensal_percentual_form.jsp
 *   .: Criação.....17 de outubro de 2008
 *   .: Autor.......Edson Luiz Sumensari
 *   .: Descrição...Tela: Formulário do Relatório de Gráfico Garantia Mensal Percentual.
 */
--%>
		...
		<script language="javascript">
			...
			function validateForm() {
				...
				if ( dataIApuracao.value == "" ) {
					...
					window.alert("A data de Início da apuração é obrigatória!");
					dataIApuracao.focus();
					return false;
					
				} else if ( dataFApuracao.value == "" ) {
				
					window.alert("A data Final de apuração é obrigatória!");
					dataFApuracao.focus();
					return false;
		...
		<table>
			...
			<tr height="25">
				<td colspan="2" align="center">
					<html:button property="create" styleClass="button_medium" onclick="submitFormTsk(reportForm,'processRelatorioGraficoGarantiaMensalPercentual',validateForm());"><bean:message key="form.btn.submit"/></html:button>	
					&nbsp;
