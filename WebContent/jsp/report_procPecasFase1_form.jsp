 ...
 *   .: Descrição...Tela: Formulário do Relatório de Processamento de Peças - Fase1.
 */
--%>
	...
	<body leftmargin="0" topmargin="3">
		...
		<table>
			<tr>
				...
				<td class="text">
					<html:select name="reportForm" property="empresaId" styleClass="listSelect" >
			...
			<tr height="25">
				<td colspan="2" align="center">
					<html:button property="create" styleClass="button_medium" onclick="submitFormTsk(reportForm,'proccessRelatorioProcPecasFase1',validateForm());"><bean:message key="form.btn.submit"/></html:button>	
					&nbsp;
