 ...
 *   .: Objeto......analiseGarantiaNautica_form.jsp
...
<html>
		...
		<script type="text/javascript">
			...
			function devolver() {
				...
				if(window.confirm("Confirma o Devolução da Solicitação de Garantia?")) {
					__showAnima();
					submitFormTsk(window.document.analiseGarantiaNauticaForm,"parecerSG&prcCode=BCK_SG",true);
				} else
					return false;
			...
			function recusar() {
				if(window.confirm("Confirma a Recusa da Solicitação de Garantia?")) {
					__showAnima();
					submitFormTsk(window.document.analiseGarantiaNauticaForm,"parecerSG&prcCode=RCU_SG",true);
				} else
					return false;
			...
			function aprovar() {
				...
				if(window.confirm("Confirma a Aprovação da Solicitação de Garantia?")) {
					__showAnima();
					submitFormTsk(window.document.analiseGarantiaNauticaForm,"parecerSG&prcCode=APV_SG",true);
				} else
					return false;
			...
			function cancelar() {
				...
				if(window.confirm("Confirma o Cancelamento da Solicitação de Garantia?")) {
					__showAnima();
					submitFormTsk(window.document.analiseGarantiaNauticaForm,"parecerSG&prcCode=CNL_SG",true);
				} else
					return false;
	...
	<body leftmargin="0" topmargin="2" onLoad="__loadEsconde();">
		...
		<html:form action="/AnaliseGarantiaNautica" method="post" enctype="multipart/form-data">			
			...
			<div align="right" class="text" >
				<span class="bold"><bean:message key="analiseGarantia.sysDate"/></span>:	
				<bean:write name="analiseGarantiaNauticaForm" property="createdDate"/>
			</div>
			<fieldset>
			...
			<tr height="25"> 
				...
				<td width="15%" class="text">	
					<bean:write name="analiseGarantiaNauticaForm" property="loteId"/>
				</td>
				<td width="9%" class="td_dark">	
					<bean:message key="analiseGarantia.label.garantia.sgnum"/>:
				</td>
				<td width="10%" class="text">	
					<bean:write name="analiseGarantiaNauticaForm" property="entityId"/>
				</td>
				<td width="8%" class="td_dark">	
				...
				<logic:equal name="analiseGarantiaNauticaForm" property="idTipo" value="1">				
					<td width="8%" class="td_dark">	
						<bean:message key="analiseGarantia.label.garantia.km"/>:
					</td>
					<td class="text">
						<bean:write name="analiseGarantiaNauticaForm" property="km"/>
					</td>
				</logic:equal>
				<logic:notEqual name="analiseGarantiaNauticaForm" property="idTipo" value="1">				
					<td width="8%" class="td_dark">	
						<bean:message key="analiseGarantia.label.garantia.horasUso"/>:
					</td>
					<td class="text">
						<bean:write name="analiseGarantiaNauticaForm" property="horasUso"/>
					</td>
				</logic:notEqual>
				<logic:notEqual name="analiseGarantiaNauticaForm" property="autorizacaoEspecial" value="">				
					...
					<td  rowspan="2" class="text" valign="middle" align="center">
						<bean:write name="analiseGarantiaNauticaForm" property="autorizacaoEspecial"/>
					</td>
				</logic:notEqual>
			</tr>
			<tr height="25"> 
			...
			<tr height="25"> 
				<td width="8%"  class="td_dark">	
					<bean:message key="analiseGarantia.label.garantia.preenchidoPor"/>:
				</td>
				<td class="text" colspan="7">	
					<html:text property="preenchidoPor" styleId="preenchidoPor" styleClass="text_field_maior" readonly="true"></html:text>							
				</td>
			</tr>
			</table>
			<br/>	
			<table width="98%" border="0" cellpadding="2" cellspacing="2" align="center" style="border: 1 1 1 1 solid #788C9B;">
				<tr>
					<td class="td_dark" width="20%"><bean:message key="garantia.form.tipo.combust"/></td>
					<td class="td_dark" width="20%"><bean:message key="garantia.form.local.uso"/></td>
					<td class="td_dark" width="20%"><bean:message key="garantia.form.tipo.uso"/></td>
				...
				<tr>
					<td class="text" align="left" valign="top">
						...
						<table border="0" cellpadding="2" cellspacing="1" width="100%">
							<logic:iterate name="analiseGarantiaNauticaForm" property="listTipoGasolina" id="tipoGasolina">
								<tr>
									<td class="text"><html:radio property="tipoGasolinaId" value="${tipoGasolina.entityId}" disabled="true"/> <core:out value="${tipoGasolina.descricao}"/></td>
								</tr>
							</logic:iterate>					
						</table>
					...
					<td class="text" align="left" valign="top">
						...
						<table border="0" cellpadding="2" cellspacing="1" width="100%">
							<tr>
								<td class="text"><html:checkbox property="localUsoSalg" value="S" disabled="true"/> <bean:message key="garantia.form.agua.salgada"/></td>
							</tr>
							<tr>
								<td class="text"><html:checkbox property="localUsoDoce" value="S" disabled="true"/> <bean:message key="garantia.form.agua.doce"/></td>
							</tr>
							<tr>
								<td class="text"><bean:message key="garantia.form.cidade.uso"/>:</td>
							</tr>
							<tr>
								<td class="text"><html:text property="cidadeUso" styleClass="text_field_maior" maxlength="30" disabled="true"/></td>
							</tr>
						</table>
					...
					<td class="text" align="left" valign="top">
						...
						<table border="0" cellpadding="2" cellspacing="1" width="100%">
							<logic:iterate name="analiseGarantiaNauticaForm" property="listTipoUso" id="tipoUso">
								<tr>
									<td class="text"><html:radio property="tipoUso" value="${tipoUso.entityId}" disabled="true"/> <core:out value="${tipoUso.descricao}"/></td>
								</tr>
							</logic:iterate>							
						</table>
					...
					<td class="text" valign="top">
						...
						<table border="0" cellpadding="2" cellspacing="1" width="100%">
							...
							<tr>
								<td class="text"><html:text property="marcaCasco" styleClass="text_field_maior" maxlength="20" disabled="true"/></td>
							</tr>
							<tr>
								<td class="text"><bean:message key="garantia.form.casco.modelo"/>:</td>
							</tr>
							<tr>
								<td class="text"><html:text property="modeloCasco" styleClass="text_field_maior" maxlength="20" disabled="true"/></td>
							</tr>
						</table>
							...
							<tr>
								<td align="left" valign="top">
									...
									<table border="0" cellpadding="2" cellspacing="1" width="100%">
										...
										<tr>
											<td class="text"><html:text property="marcaHelice" styleClass="text_field_maior" maxlength="20" disabled="true"/></td>
										</tr>
										<tr>
											<td class="text"><bean:message key="garantia.form.helice.passo"/>:</td>
										</tr>
										<tr>
											<td class="text"><html:text property="passoHelice" styleClass="text_field_maior" maxlength="15" onkeypress="return blockChar(event);" disabled="true"/></td>
										</tr>
									</table>
								...
								<td align="left" valign="top">
									<table border="0" cellpadding="2" cellspacing="1" width="100%">
										<tr>
											<td class="text"><html:radio property="materHelice" value="I" disabled="true"/><bean:message key="garantia.form.helice.material.inox"/></td>
										</tr>
										<tr>
											<td class="text"><html:radio property="materHelice" value="A" disabled="true"/><bean:message key="garantia.form.helice.material.alum"/></td>
										</tr>
										<tr>
											<td class="text"><html:radio property="materHelice" value="P" disabled="true"/><bean:message key="garantia.form.helice.material.plas"/></td>
										</tr>
									</table>
			...
			<tr height="25"> 
				...
				<td width="40%" class="text">	
					<bean:write name="analiseGarantiaNauticaForm" property="dtFaturamento"/>
				</td>
				<td width="10%" class="td_dark">	
					<bean:message key="analiseGarantia.label.analise.faturamento.ntFiscal"/>:
				</td>
				<td width="10%" class="text">	
					<bean:write name="analiseGarantiaNauticaForm" property="nuNtFiscal"/>
				</td>
				<td width="10%" class="td_dark">	
					<bean:message key="analiseGarantia.label.analise.faturamento.empresa"/>:
				</td>
				<td class="text" class="text">
					<bean:write name="analiseGarantiaNauticaForm" property="empresa"/>
				</td>
			</tr>
			<tr height="25"> 
				<td  class="td_dark">	
				...
				<td class="text">	
					<bean:write name="analiseGarantiaNauticaForm" property="dsConcessionaria"/> <br/> <bean:write name="analiseGarantiaNauticaForm" property="cnpjConc"/>							
				</td>
				<td class="td_dark">	
					<bean:message key="analiseGarantia.label.analise.faturamento.cidade"/>:
				</td>
				<td class="text">
					<bean:write name="analiseGarantiaNauticaForm" property="dsCidade"/>
				</td>
				<td class="td_dark">	
					<bean:message key="analiseGarantia.label.analise.faturamento.uf"/>:
				</td>
				<td class="text">	
					<bean:write name="analiseGarantiaNauticaForm" property="dsUf"/>
				</td>				
			</tr>
			</table>
			<br/>
			...
			<center>
			<display:table name="requestScope.analiseGarantiaNauticaForm.listRevisao" 
			...
			<center>	
			<display:table name="requestScope.analiseGarantiaNauticaForm.listGarantias" 
			               requestURI="${pageContext.request.contextPath}/AnaliseGarantia.do"
			               export="false" 
			               sort="list" 
			               id="garantia"
			...
			<center>
			<display:table name="requestScope.analiseGarantiaNauticaForm.listPecas" 
			               requestURI="${pageContext.request.contextPath}/AnaliseGarantia.do"
			               export="false" 
			               sort="list" 
			               id="peca"
				...
				<display:column titleKey="analiseGarantia.label.analise.pecas.preco" headerClass="headerAlign">						
					<c:out value="${peca.formatedValorTotalPeca}"/>
				</display:column>
			...
			<logic:notEmpty name="analiseGarantiaNauticaForm" property="listFiles">
				<table width="98%" border="0" cellpadding="2" cellspacing="2" align="center" style="border: 1 1 1 1 solid #788C9B;">
				<tr>
					<td class="td_dark"><bean:message key="analiseGarantia.label.analise.arquivo.title"/></td>
				</tr>												
				<logic:iterate name="analiseGarantiaNauticaForm" property="listFiles" id="file">
					<tr>
						<td class="text">
