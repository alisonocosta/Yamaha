 ...
 *   .: Criação.....10 de julho de 2007, 09:57
 *   .: Autor.......Edson Luiz Sumensari
 *   .: Descrição...Tela: Formulário de alteração de peça de garantia.
 */
--%>
...
<html:html>
	<head>
		...
		<html:base/>
		<html:javascript formName="garantiaPecaForm"/>		
		...
		<script language="JavaScript">
			...
			<%
				...
				List options = (List) garantiaPecaForm.get("options");
			...
			function validateLine(lineId) {
				...
				var item  = eval( "document.garantiaPecaForm.identPeca_" + lineId );
			...
			function addFilledRow(peca, qtd, enviar, cobrar, faltante) {
				...
				a.innerHTML = "<select name='identPeca_" + counter + "' style='font-family:Verdana; font-size:10px;'>" + getOptionsWithSelectedIndex(peca) + "</select>";
				a.align = "center";

				b.innerHTML = "<input type='text' name='qtdPeca_" + counter + "' size='4' maxlength='4' style='font-family:Verdana; font-size:10px;' onKeyPress='return blockChar(event);' value='" + qtd + "' onBlur='validateLine(" + counter + ");' />";
				b.align = "center";
	...
	<body leftmargin="0" topmargin="3" onload="javaScript:initialize();">
		...
		<center>
			...
			<html:form action="/GarantiaPeca" method="post">
					...
					<tr height="25"> 
						...
						<td width="75%" class="text" valign="middle">
							<table border="0" cellpadding="0" cellspacing="1">
								<tr>
									<td><html:textarea property="descricaoDefeito" cols="50" rows="5" style='font-family:Verdana; font-size:10px;'/></td>
									<td valign="middle"><html:img srcKey="form.img.required" altKey="form.msg.required"/></td>
								</tr>
							</table>
						</td>
					</tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="700">
					<tr>
						<td height="10" class="text" align="center" colspan="5">
							<input type="button" class="button_medium" name="salvar" value="Salvar" onclick="submitFormTsk(garantiaPecaForm,'save',validateGarantiaPecaForm(garantiaPecaForm))"/><%--submitFormTsk(garantiaPecaForm,'save',validateGarantiaPecaForm(garantiaPecaForm)) --%>
							&nbsp;
