 ...
 *   .: Objeto......report_0km_form.jsp
 *   .: Criação.....04 de julho de 2007
 *   .: Autor.......Gisele Panosso
 *                  Thiago Uriel M. Garcia
 *   .: Descrição...Tela: Formulário do relatório 0 Km.
 */
--%>
...
<html>
	...
	<body leftmargin="0" topmargin="3">
		...
		<table>
            ...
            <tr>
                <td class="td_dark">
 					<bean:message key="zeroKm.form.kilometragem"/>:                                                   
                </td>
            	<td>
            		<html:text name="reportForm" property="km" styleClass="text_field_menor"/> 
            	</td>
            </tr>
			<tr height="25"> 
			...
			<tr height="25">
				<td colspan="2" align="center">
					<html:button property="create" styleClass="button_medium" onclick="submitFormTsk(reportForm,'proccessRelatorioZeroKm',true);"><bean:message key="form.btn.submit"/></html:button>	
					&nbsp;
