 ...
 *   .: Objeto......report_recusa_form.jsp
 *   .: Criação.....11 de agosto de 2007
 *   .: Autor.......Gisele Panosso
 *   .: Descrição...Tela: Formulário do relatório de Recusa.
 */
--%>
	...
	<body leftmargin="0" topmargin="3">
		...
		<table>
            ...
            <tr>
            	...
            	<td>
            		<html:text name="reportForm" property="chassi"/> 
            	</td>
			</tr>		
			<tr height="25"> 
				<td width="25%" class="td_dark">	
			...
			<tr height="25">
				<td colspan="2" align="center">
					<html:button property="create" styleClass="button_medium" onclick="submitFormTsk(reportForm,'proccessRelatorioRecusa',true);"><bean:message key="form.btn.submit"/></html:button>	
					&nbsp;
