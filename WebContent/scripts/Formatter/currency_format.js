 ...
 *   .: Objeto......currency_format.js
 *   .: Criação.....18 de Agosto, 11:14
 *   .: Adaptado por.......Edson Luiz Sumensari
 *   .: Descrição...Conteúdo JavaScript para formatar valor moeda"
 */
function formatar_moeda(campo, separador_milhar, separador_decimal, tecla) {
	...
	var aux = aux2 = '';
	var whichCode = tecla ? (tecla.which ? tecla.which : tecla.keyCode) : event.keyCode;
